...
class mainWindow(QMainWindow, Ui_MainWindow) :
    ...
    # actual Barcode
    def resBarcode(self, ROW, colbar) :
        res = []
    ...
    def BtnCnv(self) :
        ...
        filePO = self.getBRC(rowPO)

        brcd = self.resBarcode(rowPO, 3)
        mdl = self.resBarcode(rowPO, 4)
        qty = self.resBarcode(rowPO, 5)
