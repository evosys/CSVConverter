...
pyinstaller --clean --noconsole --noupx --icon=resources\\icon.ico --name="CSV_Converter_eramart_citowns" --key=68b00c755cef892e512d56621925d836 --version-file=version.txt eramart_citowns.py
