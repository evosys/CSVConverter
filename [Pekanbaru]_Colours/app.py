...
class mainWindow(QMainWindow, Ui_MainWindow) :
    ...
    def getPONO(self) :
        ...
        result = self.get_cell_range(8, 8, 26, 8)
        return result
    ...
    def getBRC(self) :
        ...
        endcol = self.getLastRow() - 17

        newlist = self.get_cell_range(4, 0, 6, endcol)
    ...
    def getQTY(self) :
        ...
        newlist = self.get_cell_range(11, 0, 13, endcol)
    ...
    def getMODAL(self) :
        ...
        newlist = self.get_cell_range(28, 0, 35, endcol)
